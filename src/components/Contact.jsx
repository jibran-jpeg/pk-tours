...
const Contact = () => {
    return (
        <section id="contacts" className="relative pt-20 lg:pt-32 bg-black min-h-screen font-sans">
            {/* Background Image */}
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 flex flex-col min-h-screen lg:min-h-0 pb-10 lg:pb-0">
                <div className="max-w-md w-full mx-auto lg:mx-0 bg-white/[0.05] backdrop-blur-xl p-8 md:p-12 rounded-3xl border border-white/10 mb-16 lg:mb-32 shadow-2xl mt-8 lg:mt-0 flex-grow lg:flex-grow-0">
                    <h3 className="text-2xl text-white font-light mb-2 font-serif">Want to join us,</h3>
                    <h3 className="text-2xl text-white font-light mb-8 font-serif italic text-emerald-400">but still have questions?</h3>
                    ...
                    <form className="space-y-6">
                        ...
                        <button type="button" className="w-full bg-white text-black py-4 font-bold text-xs tracking-[0.3em] uppercase hover:bg-emerald-500 hover:text-white transition-all shadow-lg active:scale-95">
                            SEND
                        </button>
                    </form>
                </div>

                <div className="flex flex-col md:flex-row items-center justify-between py-10 lg:py-12 border-t border-white/10 gap-8 mt-auto lg:mt-0">
                    <div className="flex items-center gap-2 text-white">
                        <Globe size={16} className="text-emerald-500" />
                        <span className="font-bold tracking-[0.2em] text-xs uppercase">PK TOURS</span>
                    </div>
                    <div className="flex flex-wrap justify-center items-center gap-6 md:gap-12 text-white/40 text-[10px] font-semibold tracking-widest uppercase">
                    ...
                    <div className="flex gap-8 md:gap-6 text-white/40">
