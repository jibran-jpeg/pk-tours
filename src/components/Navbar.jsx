        ...
        <nav className={`fixed w-full z-50 transition-all duration-500 ${isScrolled ? 'bg-black/90 backdrop-blur-md py-4 shadow-lg' : 'bg-gradient-to-b from-black/50 to-transparent py-6'}`}>
            <div className="container mx-auto px-6 max-w-7xl flex items-center justify-between">
                ...
                <motion.div
                    ...
                    className={`hidden md:flex items-center gap-12 text-xs font-semibold tracking-widest uppercase ${isScrolled ? 'text-gray-300' : 'text-white/80'}`}
                >
                ...
                <div className="hidden md:flex items-center gap-4">
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className={`px-8 py-2 border rounded-full text-xs font-bold tracking-widest transition-all border-white/30 text-white hover:bg-white hover:text-black`}
                    >
                        BOOK
                    </motion.button>
                </div>
