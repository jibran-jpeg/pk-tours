...
const Services = () => {
    ...
    return (
        <section id="included" className="bg-[#0a0a0a] py-20 lg:py-32 px-6 lg:px-8 overflow-hidden font-sans">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-8 mb-12 lg:mb-20">
                    <h2 className="text-3xl md:text-5xl font-light text-white uppercase tracking-[0.2em] font-serif whitespace-nowrap">What's Included</h2>
                    <div className="hidden md:block h-px bg-white/20 flex-1" />
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                    {items.map((item, idx) => (
                        ...
                        >
                            ...
                            <h3 className="text-white font-bold text-lg uppercase tracking-widest mb-4 group-hover:text-emerald-400 transition-colors duration-300">
                                {item.title}
                            </h3>
                            <p className="text-gray-500 text-xs leading-relaxed uppercase tracking-widest mt-auto group-hover:text-gray-400 transition-colors duration-300">
                                {item.desc}
                            </p>
                        </motion.div>
                    ))}
