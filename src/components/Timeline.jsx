...
const Timeline = () => {
    ...
    return (
        <section id="about" className="bg-[#0a0a0a] py-20 lg:py-32 px-6 lg:px-8 overflow-hidden font-sans">
            <div className="max-w-7xl mx-auto">
                <div className="flex items-center gap-4 md:gap-8 mb-12 lg:mb-20">
                    <div className="h-px bg-white/20 flex-1" />
                    <h2 className="text-3xl md:text-5xl font-light text-white uppercase tracking-[0.2em] font-serif text-center drop-shadow-lg text-shadow-sm px-2">The Expedition</h2>
                    <div className="h-px bg-white/20 flex-1" />
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
                    <div className="space-y-8">
                        <motion.p
                            ...
                            viewport={{ once: true }}
                            className="text-gray-400 max-w-sm text-sm leading-relaxed uppercase tracking-wider"
                        >
                        ...
                        <div className="space-y-16 lg:space-y-32">
                            {timeline.map((item, idx) => (
                                <motion.div
                                    ...
                                    className="relative"
                                >
                                    <div className="absolute top-2 -left-[25px] md:-left-[33px] w-2 h-2 rounded-full bg-white shadow-[0_0_10px_white]" />
